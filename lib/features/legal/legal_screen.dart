...
• معرّف الإشعارات الخاص بجهازك (FCM token) عند تفعيلك للإشعارات، ويُحذف فور إيقافها من داخل التطبيق

لا نجمع موقعك الجغرافي، ولا نحتفظ بأي صورة تلتقطها الكاميرا — الكاميرا تُستخدم لقراءة الباركود فقط داخل الجهاز.'''),
...
• لا نستخدم بياناتك للإعلانات ولا لأي تتبّع'''),
    _Section('حذف حسابك', '''
تستطيع حذف حسابك وكل بياناتك بنفسك في أي وقت من داخل التطبيق:
حسابي ← أسفل الصفحة ← «حذف الحساب نهائيًا»

الحذف فوري ونهائي ولا يمكن التراجع عنه، ويشمل:
• بياناتك الشخصية وصورة ملفك
• ملاحظاتك في المرجع التفاعلي
• مفضلاتك وإحصائيات استخدامك
• معرّف الإشعارات الخاص بجهازك

لا حاجة لمراسلة الدعم، ولا نحتفظ بنسخة بعد الحذف.'''),
    _Section('التواصل والدعم',
        'لأي استفسار بشأن خصوصيتك، تواصل معنا عبر: info@iraqpharmaguide.com\n\nالنسخة الكاملة من السياسة منشورة على:\nhttps://www.iraqpharmaguide.com/privacy-policy'),
    _Section('تاريخ آخر تحديث', 'أغسطس 2026'),
  ];
...
• البحث عن معلومات الأدوية لأغراض مهنية وتعليمية
• استخدام الحاسبات وفاحص التفاعلات كأدوات تعليمية للتدريب على المعادلات المنشورة، لا كأساس لوصف علاج
...
• تستطيع حذف حسابك نهائيًا في أي وقت من داخل التطبيق دون الرجوع إلينا'''),
...
• الحاسبات في التطبيق أدوات تعليمية تطبّق معادلات منشورة في المصادر الدوائية المعتمدة، ونتائجها تقديرية للتدريب فقط
• لا تُستخدم نتائج الحاسبات لوصف علاج أو تعديل جرعة لمريض، ويجب دائمًا مراجعة الطبيب أو الصيدلاني المختص والنشرة الدوائية الرسمية'''),
...
استخدامه من قبل غير المختصين يكون على مسؤوليتهم الشخصية الكاملة.'''),
    _Section('إخلاء المسؤولية القانوني',
        'يُستخدم هذا التطبيق "كما هو" دون أي ضمانات صريحة أو ضمنية. Iraq Pharma Guide وفريق التطوير غير مسؤولين عن أي خسائر أو أضرار من أي نوع تنجم عن استخدام هذا التطبيق أو الوثوق بمعلوماته. هذا التطبيق ليس جهازًا طبيًا ولم يخضع لاعتماد أي جهة تنظيمية دوائية.'),
    _Section('تاريخ آخر تحديث', 'أغسطس 2026'),
  ];
